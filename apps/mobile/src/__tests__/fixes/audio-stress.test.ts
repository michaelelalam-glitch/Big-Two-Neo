...
// Mock expo-audio (soundManager migrated from expo-av to expo-audio in SDK 54)
...
describe('Audio Stress Test - soundManager', () => {
  ...
  it('should maintain stability over extended gameplay simulation', async () => {
    ...
    console.log(
      `[Extended Test] Error rate: ${errorCount}/${playCount} (${((errorCount / playCount) * 100).toFixed(1)}%)`
    );
